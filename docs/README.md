...
npm run test:visual # Storybook visual smoke: light/dark × density, RTL, overflow, touch targets
npm run check:css-budget # after npm run build: dist/styles.css raw/gzip budget
```
